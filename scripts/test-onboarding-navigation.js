...
const buttonWiring = [
  ...
  ["Angel field guide", /'Fill these fields in Angel One SmartAPI'/],
  ["Angel TOTP warning", /Do not enter the changing 6-digit OTP/],
  ["Upstox field guide", /'Fill these fields in Upstox Developer Apps'/],
  ["Upstox redirect URL", /option-king-saas-production\.up\.railway\.app\/upstox\/callback/],
  ["Upstox postback URL", /option-king-saas-production\.up\.railway\.app\/upstox\/postback/],
  ["Static IP field", /label:'PRIMARY STATIC IP',value:state\.assignedIp/],
  ["Upstox analytics warning", /Do not use Analytics Token for live order placement/],
