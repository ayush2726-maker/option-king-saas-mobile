...
const HELP_SECTIONS = [
  ...
  },
  {
    ...
    hi: {
      ...
      summary: "Bot Token, Chat ID और notification setup की मदद।",
      steps: [
        "Settings में Telegram/Alerts section खोलें।",
        "Bot Token और Chat ID सही भरें।",
        "Save करने के बाद test message भेजकर connection जाँचें।",
        "Trade entry, exit, P&L, strategy और system alerts configured channel पर मिल सकते हैं।",
      ],
      note: "Alert न आए तो internet, token, Chat ID और bot permission जाँचें। Trading engine alert failure के बावजूद अलग से चल सकता है।",
    },
    en: {
      title: "Telegram and Alerts",
      summary: "Help with Bot Token, Chat ID, and notification setup.",
      steps: [
        "Open Telegram or Alerts under Settings.",
        "Enter the correct Bot Token and Chat ID.",
        "Save and send a test message to verify the connection.",
        "Trade entry, exit, P&L, strategy, and system alerts can be delivered to the configured channel.",
      ],
      note: "If alerts do not arrive, check internet access, token, Chat ID, and bot permissions. The trading engine may continue independently of alert delivery.",
    },
  },
  {
    id: "subscription",
