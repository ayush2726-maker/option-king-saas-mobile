  ...
  },
  {
    ...
    hi: {
      ...
      steps: [
        ...
        "Live quantity Paper Mode के समान capital/risk sizing से अपने आप तय होगी।",
      ],
    ...
    en: {
      ...
      steps: [
        ...
        "Live quantity is calculated automatically using the same capital and risk sizing as Paper Mode.",
      ],
