      ...
      <Card glow={C.gold}>
        ...
        <View style={{ backgroundColor: C.s1, borderRadius: 10, padding: 10,
          ...
          <Text style={{ color: C.blue, fontSize: 11, lineHeight: 17, fontWeight: "800" }}>
            Fixed ₹5,000 Paytm / UPI QR se payment karein. Payment ke baad admin 30 days activate karega.
          </Text>
        </View>
        ...
        {!paymentAvailable && (
          <Text style={{ color: C.gold, fontSize: 10, lineHeight: 15, marginTop: 9 }}>
            Payment QR ready hai — amount ₹5,000 fixed hai.
          </Text>
        )}
        <Text style={{ color: C.muted, fontSize: 10, lineHeight: 15, marginTop: 8 }}>
          Manual renewal every 30 days. Payment ke baad admin confirmation se plan activate hoga.
        </Text>
      </Card>
